...
cfg_paths_template = [r"{user_home}\.apple\\mainnet\\config\\config.yaml",
                        ...
                        r"{user_home}\.cunt\\mainnet\\config\\config.yaml",
                        r"{user_home}\.dogechia\\mainnet\\config\\config.yaml",
                        r"{user_home}\.equality\\mainnet\\config\\config.yaml",
                        ...
                        r"{user_home}\.goji-blockchain\\mainnet\\config\\config.yaml",
                        ...
                        r"{user_home}\.seno2\\mainnet\\config\\config.yaml",
